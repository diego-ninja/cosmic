...
* Full name: `\Ninja\Cosmic\Command\ListCommand`
...
```php
public __invoke(bool $raw, string $format, bool $short, ?string $namespace = null): int
```
...
### getCommandHelperRenderer



```php
private getCommandHelperRenderer(): \Ninja\Cosmic\Terminal\Renderer\CommandHelpRenderer
```
